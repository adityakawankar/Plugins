...
class cb_empjourneys {
	...
	/**
	 * Meta Box: Employee Journey Meta
	 * 
	 *
	 * @access public
	 * @return void
	 */
	public function metaBoxEmployeeJourneyMeta($post, $args){
	...
	public function hookThePost(&$post){
		if($post->post_type != 'cb_empjourneys') return;
	...
	public function hookMetaBoxes(){
		add_meta_box(
			'EmployeeJourney-meta',
			'EmployeeJourney Meta',
			array(&$this, 'metaBoxEmployeeJourneyMeta'),
			'cb_empjourneys',
			'normal',
			'default',
			array()
	...
	public function hookRegisterPostType(){
		...
		$labels = array(
			...
			'singular_name' => 'Employee Journey',
			'menu_name' => 'Employee Journey',
			'add_new' => 'Add New Employee Journey',
			'add_new_item' => 'Add New Employee Journey',
			'edit' => 'Edit',
			'edit_item' => 'Edit Employee Journey',
			'new_item' => 'New Employee Journey',
			'view' => 'View Employee Journey',
			'view_item' => 'View Employee Journey',
			'search_items' => 'Search Employee Journey',
			'not_found' => 'No Employee Journey Found',
			'not_found_in_trash' => 'No Employee Journey found in Trash'
		);
		 ...
		 * Register Post type
		 */
		register_post_type('cb_empjourneys', $args);
		...
		register_taxonomy(
			...
			array(
				'label' => 'Types',
				'rewrite' => array('slug' => 'empjourney-type'),
				'hierarchical' => true,
				'public' => false,
				'show_ui' => true
			)
	...
	public function hookEnterTitleHere($title){
		...
		if( 'cb_empjourneys' == $screen->post_type ) {
			$title = 'Enter Name';
		}
