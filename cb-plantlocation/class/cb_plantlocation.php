...
class CB_PlantLocation {
	...
	/**
	 * Meta Box: plantlocation Meta
	 * 
	 *
	 * @access public
	 * @return void
	 */
	public function metaBoxplantlocationMeta($post, $args){
	...
	public function hookThePost(&$post){
		if($post->post_type != 'cb_plantlocation') return;
	...
	public function hookMetaBoxes(){
		add_meta_box(
			'plantlocation-meta',
			'News & Event Meta',
			array(&$this, 'metaBoxplantlocationMeta'),
			'cb_plantlocation',
			'normal',
			'default',
			array()
	...
	public function hookRegisterPostType(){
		...
		$labels = array(
			'name' => 'Plant location',
			'singular_name' => 'Plant location',
			'menu_name' => 'Plant location',
			'add_new' => 'Add New Plant location',
			'add_new_item' => 'Add New Plant location',
			'edit' => 'Edit',
			'edit_item' => 'Edit Plant location',
			'new_item' => 'New Plant location',
			'view' => 'View Plant location',
			'view_item' => 'View Plant location',
			'search_items' => 'Search Plant location',
			'not_found' => 'No Plant location Found',
			'not_found_in_trash' => 'No Plant location found in Trash'
		);
		 ...
		 * Register Post type
		 */
		register_post_type('cb_plantlocation', $args);
		...
		register_taxonomy(
			...
			array(
				'label' => 'Types',
				'rewrite' => array('slug' => 'plantlocation-type'),
				'hierarchical' => true,
				'public' => false,
				'show_ui' => true
			)
	...
	public function hookEnterTitleHere($title){
		...
		if( 'cb_plantlocation' == $screen->post_type ) {
			$title = 'Enter Name';
		}
