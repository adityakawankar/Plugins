...
class CB_Policies {
	 ...
	 * @return void
	 */
	public function metaBoxPoliciesMeta($post, $args){
	...
	public function hookThePost(&$post){
		if($post->post_type != 'cb_policies') return;
	...
	public function hookMetaBoxes(){
		add_meta_box(
			'Policies-meta',
			'Policies Meta',
			array(&$this, 'metaBoxpoliciesMeta'),
			'cb_policies',
			'normal',
			'default',
			array()
	...
	public function hookRegisterPostType(){
		...
		$labels = array(
			...
			'menu_name' => 'Policies',
			'add_new' => 'Add New Policies',
			'add_new_item' => 'Add New Policies',
			'edit' => 'Edit',
			'edit_item' => 'Edit Policies',
			'new_item' => 'New Policies',
			'view' => 'View Policies',
			'view_item' => 'View Policies',
		 ...
		 * Register Post type
		 */
		register_post_type('cb_policies', $args);
		...
		// 	array(
		// 		'label' => 'Types',
		// 		'rewrite' => array('slug' => 'policies_type'),
		// 		'hierarchical' => true,
		// 		'public' => false,
		// 		'show_ui' => true
		// 	)
	...
	public function hookEnterTitleHere($title){
		...
		if( 'cb_policies' == $screen->post_type ) {
			$title = 'Enter Name';
		}
