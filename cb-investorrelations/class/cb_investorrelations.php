...
class CB_Investorrelations {
	...
	public function __construct( $file ) {
		...
		$this->token = 'cb_investorrelations';
	...
	public function hookThePost(&$post){
		if($post->post_type != 'cb_investorrelations') return;
	...
	public function hookRegisterPostType(){
		...
		$labels = array(
			...
			'singular_name' => 'Investor Relations',
			'menu_name' => 'Investor Relations',
			'add_new' => 'Add New Investor Relations',
			'add_new_item' => 'Add New Investor Relations',
			'edit' => 'Edit',
			'edit_item' => 'Edit Investor Relations',
			'new_item' => 'New Investor Relations',
			'view' => 'View Investor Relations',
			'view_item' => 'View Investor Relations',
			'search_items' => 'Search Investor Relations',
			'not_found' => 'No Investor Relations Found',
			'not_found_in_trash' => 'No Investor Relations found in Trash'
		);
		 ...
		 * Register Post type
		 */
		register_post_type('cb_investorrelations', $args);

		/*
		 * Register Taxonomy
		 */
		register_taxonomy(
			'investorrelations_type',
			'cb_investorrelations',
			array(
				'label' => 'Types',
				'rewrite' => array('slug' => 'investor-relation'),
				'hierarchical' => true,
				'public' => true,
				'show_ui' => true
			)
	...
	public function hookEnterTitleHere($title){
		...
		if( 'cb_investorrelations' == $screen->post_type ) {
			$title = 'Enter Name';
		}
